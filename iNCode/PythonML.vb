...
#Region "Components"
    ...
    Public Function KNNSample() As String
        Return "from csv import reader
...
def main():
    try:
        # get value of k
        k = int(input('This is a sample K-Nearest Neigbors implementation.\nEnter the value of k : '))

        # load the training and test data set
        training_file = input('Enter name of training data file (e.g. iris-dataset.csv): ')
        test_file = input('Enter name of test data file (e.g. iris-test.csv): ')
